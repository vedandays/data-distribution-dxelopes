...
//@Ignore
public class PartitionLargeSetsParallelAlgorithmLoadTest extends AprioriLoadlTest {
	...
	public void test_T_200() throws MiningException {
		...
		System.out.println("----- PartitionLargeSetsParallelAlgorithm (" + NUMBER_HANDLERS + ") for data set " + dataSet + " -------");
