...
//@Ignore
public class ApriorLargeSetsParallelAlgorithmLoadTest extends AprioriLoadlTest {
	...
	public void test_T_200() throws MiningException {
		...
		System.out.println("----- AprioriLargeSetsParallelAlgorithm (" + NUMBER_HANDLERS + ") for data set " + dataSet + " -------");
