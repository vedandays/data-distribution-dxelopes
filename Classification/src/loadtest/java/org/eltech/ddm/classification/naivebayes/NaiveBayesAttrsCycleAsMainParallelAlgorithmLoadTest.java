...
public class NaiveBayesAttrsCycleAsMainParallelAlgorithmLoadTest extends ClassificationLoadlTest {
	...
	public void testSharedSDSM(){
		...
		try {
			...
			System.out.println("----- NaiveBayesAttrsCycleAsMainParallelAlgorithm (shared SDSM) -------");
			...
			for(int i=0; i < dataSets.length; i++){
		        ...
		        algorithm = new NaiveBayesAttrsCycleAsMainParallelAlgorithm(miningSettings);
	...
	public void testSharedMDSM(){
		...
		try {
			...
			System.out.println("----- NaiveBayesAttrsCycleAsMainParallelAlgorithm (shared MDSM) -------");
	...
	public void testSharedSDMM(){
		...
		try {
			...
			System.out.println("----- NaiveBayesAttrsCycleAsMainParallelAlgorithm (shared SDMM) -------");
	...
	public void testSharedMDMM(){
		...
		try {
			...
			System.out.println("----- NaiveBayesAttrsCycleAsMainParallelAlgorithm (shared MDMM) -------");
	...
	public void testDistrSDSM(){
		...
		try {
			...
			System.out.println("----- NaiveBayesAttrsCycleAsMainParallelAlgorithm (distributed SDSD) -------");
	...
	public void testDistrMDSM(){
		...
		try {
			...
			System.out.println("----- NaiveBayesAttrsCycleAsMainParallelAlgorithm (distributed MDSD) -------");
	...
	public void testDistrSDMM(){
		...
		try {
			...
			System.out.println("----- NaiveBayesAttrsCycleAsMainParallelAlgorithm (distributed SDMM) -------");
	...
	public void testDistrMDMM(){
		...
		try {
			...
			System.out.println("----- NaiveBayesAttrsCycleAsMainParallelAlgorithm (distributed MDMM) -------");
