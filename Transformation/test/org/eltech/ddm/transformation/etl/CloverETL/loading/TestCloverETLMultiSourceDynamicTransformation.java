...
/**
 * Test for CloverETLOneSourceDynamicTransformationActivity with not one source.
 * 
 * @author SemenchenkoA
 *
 */
public class TestCloverETLMultiSourceDynamicTransformation implements
	...
	public void testActivity() throws Exception {
		...
		cloverOneSourceActivity
				.addTransformation("CloverETLEmptyTransformation");
		cloverOneSourceActivity
				.addTransformation("CloverETLEmptyTransformation");
		cloverOneSourceActivity
				.addTransformation("CloverETLEmptyTransformation");
	...
	public void MiningETLArrayStreamPrepared(ELogicalData aLogicalData,
		...
		try {
			miningInputStream = new MiningETLArrayStream(aLogicalData,
					aDataProvider);
			((MiningETLArrayStream) miningInputStream)
					.setBatchSize(cloverOneSourceActivity.getBatchSize());
